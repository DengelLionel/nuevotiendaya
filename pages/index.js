...
export default function Home() {
	return (
		<>
			<Head>
				<title>Creamos tu tienda Online en Crea Tienda Ya</title>
				...
				<meta name="keywords" content="crear tienda online,tienda,tienda virtual, tiendas virtuales peru,tiendas virtuales gratis, tienda online, eCommerce, tienda en línea, creación de tiendas, negocio en línea,dropshipping"/>
